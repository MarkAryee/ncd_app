...
from three_explain_utils import explain_prediction
...
def predict_asthma(data: PatientData):
    ...
    return explain_prediction(model, scaler, input_df, X, disease_name="Asthma")
...
from nlp_helpers import parse_speech
